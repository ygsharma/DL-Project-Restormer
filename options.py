...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--pretrain_weights',type=str, default='./log/Restormer_B/models/model_best.pth', help='path of pretrained_weights')
        ...
        parser.add_argument('--arch', type=str, default ='Restormer_B',  help='archtechture')
