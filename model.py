...
#########################################
########### Basic layer of Restormer ################
class BasicRestormerLayer(nn.Module):
...
class Restormer(nn.Module):
    def __init__(self, img_size=256, in_chans=3, dd_in=3,
        ...
        # Encoder
        self.encoderlayer_0 = BasicRestormerLayer(dim=embed_dim,
        ...
        self.encoderlayer_1 = BasicRestormerLayer(dim=embed_dim*2,
        ...
        self.encoderlayer_2 = BasicRestormerLayer(dim=embed_dim*4,
        ...
        self.encoderlayer_3 = BasicRestormerLayer(dim=embed_dim*8,
        ...
        # Bottleneck
        self.conv = BasicRestormerLayer(dim=embed_dim*16,
        ...
        self.decoderlayer_0 = BasicRestormerLayer(dim=embed_dim*16,
                            output_dim=embed_dim*16,
                            input_resolution=(img_size // (2 ** 3),
                                                img_size // (2 ** 3)),
                            depth=depths[5],
        ...
        self.decoderlayer_1 = BasicRestormerLayer(dim=embed_dim*8,
                            output_dim=embed_dim*8,
                            input_resolution=(img_size // (2 ** 2),
                                                img_size // (2 ** 2)),
                            depth=depths[6],
        ...
        self.decoderlayer_2 = BasicRestormerLayer(dim=embed_dim*4,
                            output_dim=embed_dim*4,
                            input_resolution=(img_size // 2,
                                                img_size // 2),
                            depth=depths[7],
        ...
        self.decoderlayer_3 = BasicRestormerLayer(dim=embed_dim*2,
                            output_dim=embed_dim*2,
                            input_resolution=(img_size,
                                                img_size),
                            depth=depths[8],
...
if __name__ == "__main__":
    ...
    model_restoration = Restormer(img_size=input_size, embed_dim=16,depths=depths,
